...
function extPage() {
    ...
    try {
        var ref = window.open('https://s3.eu-central-1.amazonaws.com/playsome-games/apk/apk.html', '_blank', 'location=yes');
...
function extPageSysBrowser() {
    ...
    try {
        if (window.tinyHippos) {
            ...
            var ref = window.open('https://s3.eu-central-1.amazonaws.com/playsome-games/apk/apk.html', '_system', 'location=yes');
            console.log(fName, "try, success");
        }
    } catch (e) {
        console.log(fName, "catch, failure");
